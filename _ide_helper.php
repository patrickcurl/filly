...
')
     ...
     */ 
        ...
        {
                        return \BezhanSalleh\FilamentShield\FilamentShield::generateForResource($entity);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * @static 
         */ 
        public static function navigationGroup($navigationGroup = null)
        {
                        return \WyChoong\FilamentFortify\FilamentFortify::navigationGroup($navigationGroup);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function navigationLabel($navigationLabel = null)
        {
                        return \WyChoong\FilamentFortify\FilamentFortify::navigationLabel($navigationLabel);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function pageTitle($pageTitle = null)
        {
                        return \WyChoong\FilamentFortify\FilamentFortify::pageTitle($pageTitle);
        }
...
namespace  { 
            ...
            class FilamentFortify extends \WyChoong\FilamentFortify\Facades\FilamentFortify {}
